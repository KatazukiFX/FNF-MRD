...
class ConfettiToggle extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.confettiOn = !FlxG.save.data.confettiOn;
	...
	private override function updateDisplay():String
	{
		return "Confetti " + (!FlxG.save.data.confettiOn ? "off" : "on");
	}
}

class ConfettiType extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.confetti = !FlxG.save.data.confetti;
	...
	private override function updateDisplay():String
	{
		return "Confetti Type " + (!FlxG.save.data.confetti ? "light" : "standard");
	}
}
...
class OffsetMenu extends Option
{
	...
	public override function press():Bool
	{
		...
		PlayState.SONG = Song.loadFromJson('mad-rat-alive', '');
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.confetti = null;
		FlxG.save.data.confettiOn = null;
		FlxG.save.data.laneTransparency = 0;
