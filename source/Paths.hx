...
class Paths
{
	...
	inline static public function inst2(song:String)
	{
		var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
	...
	inline static public function preview(song:String)
	{
		var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();

		return 'songs:assets/songs/${songLowercase}/Preview.$SOUND_EXT';
	}
