...
class ResultsScreen extends FlxSubState
{
	...
	override function create()
	{
		...
		{
			music = new FlxSound().loadEmbedded(Paths.music('friends'), true, true);
			music.volume = 0;
		...
		settingsText = new FlxText(20, FlxG.height + 50, 0,
			'Mean: ${mean}ms (GREAT:${Ratings.timingWindows[3]}ms,GOOD:${Ratings.timingWindows[2]}ms,EARLY/LATE:${Ratings.timingWindows[1]}ms,MISS:${Ratings.timingWindows[0]}ms)');
