...
class KeyBindMenu extends FlxSubState
{
	...
	override function create()
	{
		...
		keyTextDisplay.setFormat(Paths.font("fot-rowdystd-eb.otf"), 42, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat(Paths.font("fot-rowdystd-eb.otf"), 24, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
