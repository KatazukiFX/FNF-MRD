...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var player2:Character = new Character(0, 0, "gf-heart");
	var player1:Boyfriend = new Boyfriend(0, 0, "bf-madratmic");
	...
	{
		var difficultyArray:Array<String> = ["", "-hard"];
