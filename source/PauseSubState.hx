...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		{
			playingPause = true;
			pauseMusic = new FlxSound().loadEmbedded(Paths.music('forest'), true, true);
			pauseMusic.volume = 0;
		...
		levelInfo.setFormat(Paths.font("fot-rowdystd-eb.otf"), 32);
		...
		levelDifficulty.setFormat(Paths.font("fot-rowdystd-eb.otf"), 32);
		...
		perSongOffset.setFormat(Paths.font("fot-rowdystd-eb.otf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
