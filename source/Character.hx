...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		{
			case 'gf-ratgod':
				tex = Paths.getSparrowAtlas('GF_RAT_GOD', 'shared', true);
				frames = tex;
			...
			case 'doctor':
				...
				tex = Paths.getSparrowAtlas('DOCTOR', 'shared', true);
				frames = tex;
				...
				playAnim('idle');
			case 'heart':
				tex = Paths.getSparrowAtlas('HEART', 'shared', true);
				frames = tex;
				...
				playAnim('idle');
			case 'cheese-man':
				tex = Paths.getSparrowAtlas('CHEESE_MAN', 'shared', true);
				frames = tex;
				...
				animation.addByPrefix('singRIGHT', 'Mom Right Pose', 24, false);
			...
			case 'bf-madrat':
				var tex = Paths.getSparrowAtlas('MAD_RAT', 'shared', true);
				frames = tex;
			...
			case 'bf-madratmic':
				var tex = Paths.getSparrowAtlas('MAD_RAT_MIC', 'shared', true);
				frames = tex;
	...
	override function update(elapsed:Float)
	{
		if (!isPlayer)
		{
			...
			if (curCharacter == 'gf-heart' || curCharacter == 'gf-ratgod')
