	...
	override function create()
	{
		options = [
			...
			new OptionCata(345, 40, "Appearance", [
				new ConfettiToggle("Toggle confetti visibility on Great notes."), new ConfettiType("Toggle confetti type based on performance."),
		...
		descText.setFormat(Paths.font("fot-rowdystd-eb.otf"), 20, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
