...
class GameplayCustomizeState extends MusicBeatState
{
	...
	public static var freeplayBf:String = 'bf-madrat';
	public static var freeplayDad:String = 'doctor';
	public static var freeplayGf:String = 'gf-heart';
	public static var freeplayNoteStyle:String = 'normal';
	public static var freeplayStage:String = 'lab';
	public static var freeplaySong:String = 'rats-dream';
	...
	public override function create()
	{
		...
		text.setFormat(Paths.font("fot-rowdystd-eb.otf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
