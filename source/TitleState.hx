...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance = new FlxSprite(FlxG.width * 0.475, FlxG.height * 0.075);
		gfDance.frames = Paths.getSparrowAtlas('gfDanceTitle');
		gfDance.animation.addByIndices('danceLeft', 'gfDance', [5, 6, 7, 8, 9, 10, 11, 12, 13], "", 24, false);
		gfDance.animation.addByIndices('danceRight', 'gfDance', [14, 15, 16, 17, 18, 19, 0, 1, 2, 3, 4], "", 24, false);
		gfDance.antialiasing = FlxG.save.data.antialiasing;
		add(gfDance);
		add(logoBl);

		titleText = new FlxSprite(125, FlxG.height * 0.8375);
		...
		else
		{
			...
			FlxTransitionableState.defaultTransIn = new TransitionData(FADE, FlxColor.BLACK, 1, new FlxPoint(0, -1), {asset: diamond, width: 32, height: 32},
				new FlxRect(-600, -600, FlxG.width * 3, FlxG.height * 4.2));
			FlxTransitionableState.defaultTransOut = new TransitionData(FADE, FlxColor.BLACK, 0.7, new FlxPoint(0, 1),
				{asset: diamond, width: 32, height: 32}, new FlxRect(-600, -600, FlxG.width * 6, FlxG.height * 4.2));
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			case 0:
				deleteCoolText();
			case 1:
				createCoolText(['Kudos to']);
			// credTextShit.visible = true;
			case 2:
				addMoreText('The Original FNF Team');
				addMoreText('and KadeDeveloper');
			// credTextShit.text += '\npresent...';
			...
			// credTextShit.screenCenter();
			case 4:
				createCoolText(['Katazuki', 'NCH']);
			case 5:
				addMoreText('You cant beat D');
				addMoreText('Cutila-Mun');
				addMoreText('Yamahearted');
			case 6:
